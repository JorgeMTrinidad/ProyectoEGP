    ...
    public function index(Request $request)
    {
        ...
        if ($request) {
            ...
            $ingresos = Ingreso::join('proveedores', 'ingresos.idproveedor', '=', 'proveedores.id')
                ...
                ->select(
                    'ingresos.id',
                    'ingresos.tipo_identificacion',
                    'ingresos.num_ingreso',
    ...
    public function show($id)
    {
        ...
        $ingreso = Ingreso::join('proveedores', 'ingresos.idproveedor', '=', 'proveedores.id')
            ...
            ->select(
                ...
                'ingresos.fecha_ingreso',
                'ingresos.estado',
                DB::raw('sum(detalle_ingresos.cantidad*precio) as total'),
                'proveedores.nombre'
            )
        ...
        $detalles = DetalleIngreso::join('productos', 'detalle_ingresos.idproducto', '=', 'productos.id')
            ->select('detalle_ingresos.cantidad', 'detalle_ingresos.precio', 'detalle_ingresos.id', 'productos.nombre as producto')
