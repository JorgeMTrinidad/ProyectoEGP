...
<html>
    ...
    <title>Reporte de venta al crétido</title>
    <style>
        body {
        /*position: relative;*/
        /*width: 16cm;  */
    ...
    <body>
        ...
        <header>
            ...
            <div id="fact">
                <p>TRANSAC.-{{$c->tipo_identificacion}}<br>
                  {{$c->num_credito}}</p>
            </div>
        </header>
        <br>
                ...
                <table id="facproducto">
                    ...
                    <tfoot>
                        ...
                        <tr>
                            ...
                            <td><p align="right">Q{{number_format($c->subtotal,2)}}</p></td>
                         </tr>
 
                         <tr>
                             <th  colspan="3"><p align="right">DESCUENTO:</p></th>
                             <td><p align="right">Q{{number_format($c->subtotal-$c->total,2)}}</p></td>
                         </tr>
 
                         <tr>
                             <th  colspan="3"><p align="right">TOTAL:</p></th>
                             <td><p align="right">Q{{number_format($c->total,2)}}</p></td>
                         </tr>
