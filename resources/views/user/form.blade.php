     ...
     <div class="form-group row">
            ...
            <div class="col-md-9">
                ...
                <select class="form-control" name="tipo_documento" id="tipo_documento">
                    ...
                    <option value="CodEmpleado">Código de Empleado</option>
    ...
    <div class="form-group row">
                ...
                <div class="col-md-9">
                    ...
                    <input type="text" id="usuario" name="usuario" class="form-control" placeholder="Ingrese el usuario" required pattern="^[a-zA-Z_áéíóúñ\s]{0,30}$">
